...
const record_2 = require("../../common/pipes/validations/record");
let RecordResolver = class RecordResolver {
    ...
    modifyDescription(modifyDescriptionPayload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.recordService.modifyDescription(modifyDescriptionPayload);
        });
    }
...
__decorate([
    graphql_1.Mutation(),
    __param(0, graphql_1.Args(resolverArguments_1.MODIFY_RECORD_DESCRIPTION)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], RecordResolver.prototype, "modifyDescription", null);
__decorate([
...
RecordResolver = __decorate([
    ...
    common_1.UsePipes(record_2.RecordValidationPipe),
